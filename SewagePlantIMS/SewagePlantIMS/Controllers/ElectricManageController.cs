    ...
    public class ElectricManageController : Controller
    {
        ...
        "where dm_electric_inspection.id = " + Convert.ToInt32(Request.Form["erl_id"]) + " and " +
           ...
           if (ds.Tables[0].Rows[0][2] != System.DBNull.Value) Model.control_room_state = Convert.ToInt32(ds.Tables[0].Rows[0][2]); else Model.control_room_state = null;
            ...
            if (ds.Tables[0].Rows[0][10] != System.DBNull.Value) Model.elvd1_v_a = Convert.ToDouble(ds.Tables[0].Rows[0][10].ToString()); else Model.elvd1_v_a = null;
            if (ds.Tables[0].Rows[0][11] != System.DBNull.Value) Model.elvd1_v_b = Convert.ToDouble(ds.Tables[0].Rows[0][11].ToString()); else Model.elvd1_v_b = null;
            if (ds.Tables[0].Rows[0][12] != System.DBNull.Value) Model.elvd1_v_c = Convert.ToDouble(ds.Tables[0].Rows[0][12].ToString()); else Model.elvd1_v_c = null;
            if (ds.Tables[0].Rows[0][13] != System.DBNull.Value) Model.elvd1_e_a = Convert.ToDouble(ds.Tables[0].Rows[0][13].ToString()); else Model.elvd1_e_a = null;
            if (ds.Tables[0].Rows[0][14] != System.DBNull.Value) Model.elvd1_e_b = Convert.ToDouble(ds.Tables[0].Rows[0][14].ToString()); else Model.elvd1_e_b = null;
            if (ds.Tables[0].Rows[0][15] != System.DBNull.Value) Model.elvd1_e_c = Convert.ToDouble(ds.Tables[0].Rows[0][15].ToString()); else Model.elvd1_e_c = null;
            if (ds.Tables[0].Rows[0][16] != System.DBNull.Value) Model.elvd1_pf = Convert.ToDouble(ds.Tables[0].Rows[0][16].ToString()); else Model.elvd1_pf = null;
            if (ds.Tables[0].Rows[0][17] != System.DBNull.Value) Model.elvd2_v_a = Convert.ToDouble(ds.Tables[0].Rows[0][17].ToString()); else Model.elvd2_v_a = null;
            if (ds.Tables[0].Rows[0][18] != System.DBNull.Value) Model.elvd2_v_b = Convert.ToDouble(ds.Tables[0].Rows[0][18].ToString()); else Model.elvd2_v_b = null;
            if (ds.Tables[0].Rows[0][19] != System.DBNull.Value) Model.elvd2_v_c = Convert.ToDouble(ds.Tables[0].Rows[0][19].ToString()); else Model.elvd2_v_c = null;
            if (ds.Tables[0].Rows[0][20] != System.DBNull.Value) Model.elvd2_e_a = Convert.ToDouble(ds.Tables[0].Rows[0][20].ToString()); else Model.elvd2_e_a = null;
            if (ds.Tables[0].Rows[0][21] != System.DBNull.Value) Model.elvd2_e_b = Convert.ToDouble(ds.Tables[0].Rows[0][21].ToString()); else Model.elvd2_e_b = null;
            if (ds.Tables[0].Rows[0][22] != System.DBNull.Value) Model.elvd2_e_c = Convert.ToDouble(ds.Tables[0].Rows[0][22].ToString()); else Model.elvd2_e_c = null;
            if (ds.Tables[0].Rows[0][23] != System.DBNull.Value) Model.elvd2_pf = Convert.ToDouble(ds.Tables[0].Rows[0][23].ToString()); else Model.elvd2_pf = null;
            if (ds.Tables[0].Rows[0][24] != System.DBNull.Value) Model.elvs_v_a = Convert.ToDouble(ds.Tables[0].Rows[0][24].ToString()); else Model.elvs_v_a = null;
            if (ds.Tables[0].Rows[0][25] != System.DBNull.Value) Model.elvs_v_b = Convert.ToDouble(ds.Tables[0].Rows[0][25].ToString()); else Model.elvs_v_b = null;
            if (ds.Tables[0].Rows[0][26] != System.DBNull.Value) Model.elvs_v_c = Convert.ToDouble(ds.Tables[0].Rows[0][26].ToString()); else Model.elvs_v_c = null;
            if (ds.Tables[0].Rows[0][27] != System.DBNull.Value) Model.elvs_e_a = Convert.ToDouble(ds.Tables[0].Rows[0][27].ToString()); else Model.elvs_e_a = null;
            if (ds.Tables[0].Rows[0][28] != System.DBNull.Value) Model.elvs_e_b = Convert.ToDouble(ds.Tables[0].Rows[0][28].ToString()); else Model.elvs_e_b = null;
            if (ds.Tables[0].Rows[0][29] != System.DBNull.Value) Model.elvs_e_c = Convert.ToDouble(ds.Tables[0].Rows[0][29].ToString()); else Model.elvs_e_c = null;
            if (ds.Tables[0].Rows[0][30] != System.DBNull.Value) Model.ehvd1_v_a = Convert.ToDouble(ds.Tables[0].Rows[0][30].ToString()); else Model.ehvd1_v_a = null;
            if (ds.Tables[0].Rows[0][31] != System.DBNull.Value) Model.ehvd1_v_b = Convert.ToDouble(ds.Tables[0].Rows[0][31].ToString()); else Model.ehvd1_v_b = null;
            if (ds.Tables[0].Rows[0][32] != System.DBNull.Value) Model.ehvd1_v_c = Convert.ToDouble(ds.Tables[0].Rows[0][32].ToString()); else Model.ehvd1_v_c = null;
            if (ds.Tables[0].Rows[0][33] != System.DBNull.Value) Model.ehvd1_e_a = Convert.ToDouble(ds.Tables[0].Rows[0][33].ToString()); else Model.ehvd1_e_a = null;
            if (ds.Tables[0].Rows[0][34] != System.DBNull.Value) Model.ehvd1_e_b = Convert.ToDouble(ds.Tables[0].Rows[0][34].ToString()); else Model.ehvd1_e_b = null;
            if (ds.Tables[0].Rows[0][35] != System.DBNull.Value) Model.ehvd1_e_c = Convert.ToDouble(ds.Tables[0].Rows[0][35].ToString()); else Model.ehvd1_e_c = null;
            if (ds.Tables[0].Rows[0][36] != System.DBNull.Value) Model.ehvd1_transformer_temp_a = Convert.ToDouble(ds.Tables[0].Rows[0][36].ToString()); else Model.ehvd1_transformer_temp_a = null;
            if (ds.Tables[0].Rows[0][37] != System.DBNull.Value) Model.ehvd1_transformer_temp_b = Convert.ToDouble(ds.Tables[0].Rows[0][37].ToString()); else Model.ehvd1_transformer_temp_b = null;
            if (ds.Tables[0].Rows[0][38] != System.DBNull.Value) Model.ehvd1_transformer_temp_c = Convert.ToDouble(ds.Tables[0].Rows[0][38].ToString()); else Model.ehvd1_transformer_temp_c = null;
            if (ds.Tables[0].Rows[0][39] != System.DBNull.Value) Model.ehvd2_v_a = Convert.ToDouble(ds.Tables[0].Rows[0][39].ToString()); else Model.ehvd2_v_a = null;
            if (ds.Tables[0].Rows[0][40] != System.DBNull.Value) Model.ehvd2_v_b = Convert.ToDouble(ds.Tables[0].Rows[0][40].ToString()); else Model.ehvd2_v_b = null;
            if (ds.Tables[0].Rows[0][41] != System.DBNull.Value) Model.ehvd2_v_c = Convert.ToDouble(ds.Tables[0].Rows[0][41].ToString()); else Model.ehvd2_v_c = null;
            if (ds.Tables[0].Rows[0][42] != System.DBNull.Value) Model.ehvd2_e_a = Convert.ToDouble(ds.Tables[0].Rows[0][42].ToString()); else Model.ehvd2_e_a = null;
            if (ds.Tables[0].Rows[0][43] != System.DBNull.Value) Model.ehvd2_e_b = Convert.ToDouble(ds.Tables[0].Rows[0][43].ToString()); else Model.ehvd2_e_b = null;
            if (ds.Tables[0].Rows[0][44] != System.DBNull.Value) Model.ehvd2_e_c = Convert.ToDouble(ds.Tables[0].Rows[0][44].ToString()); else Model.ehvd2_e_c = null;
            if (ds.Tables[0].Rows[0][45] != System.DBNull.Value) Model.ehvd2_transformer_temp_a = Convert.ToDouble(ds.Tables[0].Rows[0][45].ToString()); else Model.ehvd2_transformer_temp_a = null;
            if (ds.Tables[0].Rows[0][46] != System.DBNull.Value) Model.ehvd2_transformer_temp_b = Convert.ToDouble(ds.Tables[0].Rows[0][46].ToString()); else Model.ehvd2_transformer_temp_b = null;
            if (ds.Tables[0].Rows[0][47] != System.DBNull.Value) Model.ehvd2_transformer_temp_c = Convert.ToDouble(ds.Tables[0].Rows[0][47].ToString()); else Model.ehvd2_transformer_temp_c = null;
            if (ds.Tables[0].Rows[0][48] != System.DBNull.Value) Model.emr1_postive_active_all = Convert.ToDouble(ds.Tables[0].Rows[0][48].ToString()); else Model.emr1_postive_active_all = null;
            if (ds.Tables[0].Rows[0][49] != System.DBNull.Value) Model.emr1_postive_active_sharp = Convert.ToDouble(ds.Tables[0].Rows[0][49].ToString()); else Model.emr1_postive_active_sharp = null;
            if (ds.Tables[0].Rows[0][50] != System.DBNull.Value) Model.emr1_postive_active_peak = Convert.ToDouble(ds.Tables[0].Rows[0][50].ToString()); else Model.emr1_postive_active_peak = null;
            if (ds.Tables[0].Rows[0][51] != System.DBNull.Value) Model.emr1_postive_active_shoulder = Convert.ToDouble(ds.Tables[0].Rows[0][51].ToString()); else Model.emr1_postive_active_shoulder = null;
            if (ds.Tables[0].Rows[0][52] != System.DBNull.Value) Model.emr1_postive_active_offpeak = Convert.ToDouble(ds.Tables[0].Rows[0][52].ToString()); else Model.emr1_postive_active_offpeak = null;
            if (ds.Tables[0].Rows[0][53] != System.DBNull.Value) Model.emr1_postive_reactive_all = Convert.ToDouble(ds.Tables[0].Rows[0][53].ToString()); else Model.emr1_postive_reactive_all = null;
            if (ds.Tables[0].Rows[0][54] != System.DBNull.Value) Model.emr1_postive_reactive_sharp = Convert.ToDouble(ds.Tables[0].Rows[0][54].ToString()); else Model.emr1_postive_reactive_sharp = null;
            if (ds.Tables[0].Rows[0][55] != System.DBNull.Value) Model.emr1_postive_reactive_peak = Convert.ToDouble(ds.Tables[0].Rows[0][55].ToString()); else Model.emr1_postive_reactive_peak = null;
            if (ds.Tables[0].Rows[0][56] != System.DBNull.Value) Model.emr1_postive_reactive_shoulder = Convert.ToDouble(ds.Tables[0].Rows[0][56].ToString()); else Model.emr1_postive_reactive_shoulder = null;
            if (ds.Tables[0].Rows[0][57] != System.DBNull.Value) Model.emr1_postive_reactive_offpeak = Convert.ToDouble(ds.Tables[0].Rows[0][57].ToString()); else Model.emr1_postive_reactive_offpeak = null;
            if (ds.Tables[0].Rows[0][58] != System.DBNull.Value) Model.emr1_pf_all = Convert.ToDouble(ds.Tables[0].Rows[0][58].ToString()); else Model.emr1_pf_all = null;
            if (ds.Tables[0].Rows[0][59] != System.DBNull.Value) Model.emr1_pf_a = Convert.ToDouble(ds.Tables[0].Rows[0][59].ToString()); else Model.emr1_pf_a = null;
            if (ds.Tables[0].Rows[0][60] != System.DBNull.Value) Model.emr1_pf_b = Convert.ToDouble(ds.Tables[0].Rows[0][60].ToString()); else Model.emr1_pf_b = null;
            if (ds.Tables[0].Rows[0][61] != System.DBNull.Value) Model.emr1_pf_c = Convert.ToDouble(ds.Tables[0].Rows[0][61].ToString()); else Model.emr1_pf_c = null;
            if (ds.Tables[0].Rows[0][62] != System.DBNull.Value) Model.emr2_postive_active_all = Convert.ToDouble(ds.Tables[0].Rows[0][62].ToString()); else Model.emr2_postive_active_all = null;
            if (ds.Tables[0].Rows[0][63] != System.DBNull.Value) Model.emr2_postive_active_sharp = Convert.ToDouble(ds.Tables[0].Rows[0][63].ToString()); else Model.emr2_postive_active_sharp = null;
            if (ds.Tables[0].Rows[0][64] != System.DBNull.Value) Model.emr2_postive_active_peak = Convert.ToDouble(ds.Tables[0].Rows[0][64].ToString()); else Model.emr2_postive_active_peak = null;
            if (ds.Tables[0].Rows[0][65] != System.DBNull.Value) Model.emr2_postive_active_shoulder = Convert.ToDouble(ds.Tables[0].Rows[0][65].ToString()); else Model.emr2_postive_active_shoulder = null;
            if (ds.Tables[0].Rows[0][66] != System.DBNull.Value) Model.emr2_postive_active_offpeak = Convert.ToDouble(ds.Tables[0].Rows[0][66].ToString()); else Model.emr2_postive_active_offpeak = null;
            if (ds.Tables[0].Rows[0][67] != System.DBNull.Value) Model.emr2_postive_reactive_all = Convert.ToDouble(ds.Tables[0].Rows[0][67].ToString()); else Model.emr2_postive_reactive_all = null;
            if (ds.Tables[0].Rows[0][68] != System.DBNull.Value) Model.emr2_postive_reactive_sharp = Convert.ToDouble(ds.Tables[0].Rows[0][68].ToString()); else Model.emr2_postive_reactive_sharp = null;
            if (ds.Tables[0].Rows[0][69] != System.DBNull.Value) Model.emr2_postive_reactive_peak = Convert.ToDouble(ds.Tables[0].Rows[0][69].ToString()); else Model.emr2_postive_reactive_peak = null;
            if (ds.Tables[0].Rows[0][70] != System.DBNull.Value) Model.emr2_postive_reactive_shoulder = Convert.ToDouble(ds.Tables[0].Rows[0][70].ToString()); else Model.emr2_postive_reactive_shoulder = null;
            if (ds.Tables[0].Rows[0][71] != System.DBNull.Value) Model.emr2_postive_reactive_offpeak = Convert.ToDouble(ds.Tables[0].Rows[0][71].ToString()); else Model.emr2_postive_reactive_offpeak = null;
            if (ds.Tables[0].Rows[0][72] != System.DBNull.Value) Model.emr2_pf_all = Convert.ToDouble(ds.Tables[0].Rows[0][72].ToString()); else Model.emr2_pf_all = null;
            if (ds.Tables[0].Rows[0][73] != System.DBNull.Value) Model.emr2_pf_a = Convert.ToDouble(ds.Tables[0].Rows[0][73].ToString()); else Model.emr2_pf_a = null;
            if (ds.Tables[0].Rows[0][74] != System.DBNull.Value) Model.emr2_pf_b = Convert.ToDouble(ds.Tables[0].Rows[0][74].ToString()); else Model.emr2_pf_b = null;
            if (ds.Tables[0].Rows[0][75] != System.DBNull.Value) Model.emr2_pf_c = Convert.ToDouble(ds.Tables[0].Rows[0][75].ToString()); else Model.emr2_pf_c = null;
            if (ds.Tables[0].Rows[0][76] != System.DBNull.Value) Model.total_id = Convert.ToInt32(ds.Tables[0].Rows[0][76].ToString()); else Model.total_id = null;
            con.Close();
            return View(Model);
        }
        ...
        "where dm_electric_inspection.id = " + Convert.ToInt32(Request.Form["erl_id"]) + " and " +
            ...
            using (FileStream file = new FileStream(HttpContext.Request.PhysicalApplicationPath + @"ExcelModel\ElecReading.xls", FileMode.Open, FileAccess.Read))
            {
                ...
                //电表1线赋值
                sheet1.GetRow(4).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_active_all).ToString("f2"));
                sheet1.GetRow(5).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_active_sharp).ToString("f2"));
                sheet1.GetRow(6).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_active_peak).ToString("f2"));
                sheet1.GetRow(7).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_active_shoulder).ToString("f2"));
                sheet1.GetRow(8).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_active_offpeak).ToString("f2"));
                sheet1.GetRow(9).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_reactive_all).ToString("f2"));
                sheet1.GetRow(10).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_reactive_sharp).ToString("f2"));
                sheet1.GetRow(11).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_reactive_peak).ToString("f2"));
                sheet1.GetRow(12).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_reactive_shoulder).ToString("f2"));
                sheet1.GetRow(13).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_postive_reactive_offpeak).ToString("f2"));
                sheet1.GetRow(14).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_pf_all).ToString("f2"));
                sheet1.GetRow(15).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_pf_a).ToString("f2"));
                sheet1.GetRow(16).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_pf_b).ToString("f2"));
                sheet1.GetRow(17).GetCell(3).SetCellValue(Convert.ToDouble(Model.emr1_pf_c).ToString("f2"));
                //电表2线赋值
                sheet1.GetRow(4).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_active_all).ToString("f2"));
                sheet1.GetRow(5).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_active_sharp).ToString("f2"));
                sheet1.GetRow(6).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_active_peak).ToString("f2"));
                sheet1.GetRow(7).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_active_shoulder).ToString("f2"));
                sheet1.GetRow(8).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_active_offpeak).ToString("f2"));
                sheet1.GetRow(9).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_reactive_all).ToString("f2"));
                sheet1.GetRow(10).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_reactive_sharp).ToString("f2"));
                sheet1.GetRow(11).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_reactive_peak).ToString("f2"));
                sheet1.GetRow(12).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_reactive_shoulder).ToString("f2"));
                sheet1.GetRow(13).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_postive_reactive_offpeak).ToString("f2"));
                sheet1.GetRow(14).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_pf_all).ToString("f2"));
                sheet1.GetRow(15).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_pf_a).ToString("f2"));
                sheet1.GetRow(16).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_pf_b).ToString("f2"));
                sheet1.GetRow(17).GetCell(4).SetCellValue(Convert.ToDouble(Model.emr2_pf_c).ToString("f2"));
                //高压1线赋值
                sheet1.GetRow(18).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_v_a).ToString("f2"));
                sheet1.GetRow(19).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_v_b).ToString("f2"));
                sheet1.GetRow(20).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_v_c).ToString("f2"));
                sheet1.GetRow(21).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_e_a).ToString("f2"));
                sheet1.GetRow(22).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_e_b).ToString("f2"));
                sheet1.GetRow(23).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_e_c).ToString("f2"));
                sheet1.GetRow(24).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_transformer_temp_a).ToString("f2"));
                sheet1.GetRow(25).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_transformer_temp_b).ToString("f2"));
                sheet1.GetRow(26).GetCell(3).SetCellValue(Convert.ToDouble(Model.ehvd1_transformer_temp_c).ToString("f2"));
                //高压2线赋值
                sheet1.GetRow(18).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_v_a).ToString("f2"));
                sheet1.GetRow(19).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_v_b).ToString("f2"));
                sheet1.GetRow(20).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_v_c).ToString("f2"));
                sheet1.GetRow(21).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_e_a).ToString("f2"));
                sheet1.GetRow(22).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_e_b).ToString("f2"));
                sheet1.GetRow(23).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_e_c).ToString("f2"));
                sheet1.GetRow(24).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_transformer_temp_a).ToString("f2"));
                sheet1.GetRow(25).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_transformer_temp_b).ToString("f2"));
                sheet1.GetRow(26).GetCell(4).SetCellValue(Convert.ToDouble(Model.ehvd2_transformer_temp_c).ToString("f2"));
                //低压母联赋值
                sheet1.GetRow(27).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvs_v_a).ToString("f2"));
                sheet1.GetRow(27).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvs_v_b).ToString("f2"));
                sheet1.GetRow(27).GetCell(5).SetCellValue(Convert.ToDouble(Model.elvs_v_c).ToString("f2"));
                sheet1.GetRow(28).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvs_e_a).ToString("f2"));
                sheet1.GetRow(28).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvs_e_b).ToString("f2"));
                sheet1.GetRow(28).GetCell(5).SetCellValue(Convert.ToDouble(Model.elvs_e_c).ToString("f2"));
                //低压1线
                sheet1.GetRow(29).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_v_a).ToString("f2"));
                sheet1.GetRow(30).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_v_b).ToString("f2"));
                sheet1.GetRow(31).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_v_c).ToString("f2"));
                sheet1.GetRow(32).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_e_a).ToString("f2"));
                sheet1.GetRow(33).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_e_b).ToString("f2"));
                sheet1.GetRow(34).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_e_c).ToString("f2"));
                sheet1.GetRow(35).GetCell(3).SetCellValue(Convert.ToDouble(Model.elvd1_pf).ToString("f2"));
                //低压2线
                sheet1.GetRow(29).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_v_a).ToString("f2"));
                sheet1.GetRow(30).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_v_b).ToString("f2"));
                sheet1.GetRow(31).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_v_c).ToString("f2"));
                sheet1.GetRow(32).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_e_a).ToString("f2"));
                sheet1.GetRow(33).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_e_b).ToString("f2"));
                sheet1.GetRow(34).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_e_c).ToString("f2"));
                sheet1.GetRow(35).GetCell(4).SetCellValue(Convert.ToDouble(Model.elvd2_pf).ToString("f2"));
                //其他检查
